...
YlOrGn <- function (n, name = c("Yl_Or_Gn")) 
  {
...
Samples <- Samples[colnames(a) %in% c("Mouse_ID", "Ct_mean", "Oocyst_Predict", "Latitude", "Longitude")] 
...
data_col_MSC6         = colorFactor(brewer.pal(2, "YlGn"), HMHZ$MSC6_Subtype, reverse = F)
data_col_GP60         = colorFactor(brewer.pal(2, "YlGn"), HMHZ$GP60_Subtype, reverse = F)
data_col_GP60_Ssp    = colorFactor(brewer.pal(4, "YlGn"), HMHZ$GP60_Ssp, reverse = F)
data_col_GST   = colorFactor(brewer.pal(2, "YlGn"), HMHZ$GST_Subtype, reverse = F)
data_col_Trap  = colorFactor(brewer.pal(2, "YlGn"), HMHZ$TRAP_C1_Subtype, reverse = F)
data_col_SKSR  = colorFactor(brewer.pal(2, "YlGn"), HMHZ$SKSR_Subtype, reverse = F)
data_col_MEDLE = colorFactor(brewer.pal(2, "YlGn"), HMHZ$MEDLE_Subtype, reverse = F)
data_col_CP56  = colorFactor(brewer.pal(2, "YlGn"), HMHZ$CP56_Subtype, reverse = F)
data_col_Actin  = colorFactor(brewer.pal(2, "YlGn"), HMHZ$Actin_Subtype, reverse = F)
data_col_COWP  = colorFactor(brewer.pal(2, "YlGn"), HMHZ$COWP_Subtype, reverse = F)
data_col_Species = colorFactor(brewer.pal(3, "Blues"), HMHZ$Species)
...
Clades$HI_Level <-  cut(Clades$HI, c(0, 0.001, 0.250, 0.500, 0.750, 0.999, 1), include.lowest = T , labels = c('HI = 0', 'HI < 0.25', 'HI < 0.5', 'HI < 0.75', 'HI < 1', 'HI = 1'))
