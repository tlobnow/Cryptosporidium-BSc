...
Kvac <- read.csv("https://raw.githubusercontent.com/tlobnow/Cryptosporidium-BSc/Main-Branch/Analysis/Kvac_Samples_Locations.csv", na.strings=c(""," ","NA")) %>% filter(!is.na(Longitude)) 
...
Kvac[ ,c(1:8, 10:12)] %>% arrange(GP60_Subtype, HI) %>% kable(align = c("cccccccccc"))
...
Sequenced[,1:13] %>% kable(align = c("ccccccccccccc"))
...
data_col_GP60         = colorFactor(beach(9), Sequenced$GP60_Subtype, rev = T)
...
## Consensus Tree of concatenated sequences

![](https://raw.githubusercontent.com/tlobnow/Cryptosporidium-BSc/Main-Branch/Analysis/concatenated_Tree.png)

```{r Distance Matrix, message = F, warning=FALSE, echo=F}
Dist <- read.csv("https://raw.githubusercontent.com/tlobnow/Cryptosporidium-BSc/Main-Branch/Analysis/concat_Tree_Distances.csv")
kable(Dist)
```

![](https://raw.githubusercontent.com/tlobnow/Cryptosporidium-BSc/Main-Branch/Analysis/HMHZ_Kvac_Tree.png)