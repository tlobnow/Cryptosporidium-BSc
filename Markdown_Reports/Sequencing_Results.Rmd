...
data_col_GP60  = colorFactor(beach(3), Kvac$GP60_Subtype, rev = F)
data_col_Actin = colorFactor(beach(3), Kvac$Actin_Subtype, rev = F)
data_col_Trap  = colorFactor(beach(3), Kvac$TRAP.C1_Subtype, rev = F)
data_col_COWP  = colorFactor(beach(3), Kvac$COWP_Subtype, rev = F)
