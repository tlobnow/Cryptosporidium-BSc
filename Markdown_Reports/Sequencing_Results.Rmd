...
The highly infected samples were tested against Eimeria with Eim_COI_M_F (ATGTCACTNTCTCCAACCTCAGT) and Eim_COI_M_R (GAGCAACATCAANAGCAGTGT), primers that target a short mitochondrial COI region (700bp product).

Cecum wall tissue was extracted using the "innuPREP DNA Mini Kit” from Analytik Jena AG and standardized for PCR

PCR Mastermix consists of 1X DreamTaq Buffer, 0.5 mM dNTP Mix, 0.25 µM from each primer, and 1–20 ng/µl of DNA template in 25 µl reaction. 

PCR Protocol:

- 95°C initial denaturation (4 min)
- 35 cycles of 92°C denaturation (45 s)
- 35 cycles of annealing at 52°C (30 s)
- 35 cycles of extension at 72°C (90 s)
- final extension at 72°C (10 min)


# Conclusion

- **Eimeria:** strong bands for 901 and 902.. location is the same as our strongest infected sample 900.. it doesn't look to be infected in the gel, but since it is the same location it's still very likely to cause difficulties for you.

- **Sequencing:** Not sure what to make of the sequencing results at this point.. will need more sequences from this week, but sending samples is probably best.
--> More results follow under this link soon ..