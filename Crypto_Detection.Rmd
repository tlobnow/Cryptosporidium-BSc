...
Normal_Locations <- Crypto_Detection %>% filter(Top_Location == F)
...
map %>%
  addCircleMarkers(data = Normal_Locations, 
  ...
  addCircleMarkers(data = Top_Locations, 
                   ...
                   opacity = 1,
                   group = "Top_Locations") %>%
  addLayersControl(overlayGroups = c("Top_Locations", 
                                  "Normal_Locations"),
                   options = layersControlOptions(collapsed = F))
