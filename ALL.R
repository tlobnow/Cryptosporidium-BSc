...
## make Column names uniform across tables, especially Mouse_ID should be universal!
...
table(JardaTable_new.old$Year)
table(JardaTable_new.old$HI)
JardaTable_new.old %>%
  count(HI)

vis_miss(HIJardaTable)
vis_miss(JardaTable10_19)
vis_miss(Jarda_new)
